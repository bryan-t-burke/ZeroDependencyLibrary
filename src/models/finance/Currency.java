...
public enum Currency {
    ...
    // todo go back and add decimal places
    ...
    VED("926", "Venezuelan digital bolivar"),
    VES("928", "Venezuelan sovereign bolivar"),
    ...
    Currency(String numericCode, String currencyName) {
